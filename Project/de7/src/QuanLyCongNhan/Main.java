...
public class Main extends javax.swing.JFrame {
    ...
    ArrayList<ConNhan> cn=new ArrayList<ConNhan>();
    ArrayList<DanhSachCong> ds=new ArrayList<DanhSachCong>();
    ...
    private void themSoNgay(){
        comboSoNgayLV.removeAllItems();
        for(int i=1;i<=31;i++){
            comboSoNgayLV.addItem(i+"");
        }
    }
    private void hienCongNhan(){
        ...
        try {
            ...
            while(sc.hasNext()){
                ...
                if(kt==1){
                    ConNhan v=new ConNhan(maNV, tenNV, diaChi, sdt, bacTho);
                    cn.add(v);
                    kt=0;
                }
            }
    ...
    private void hienXuong(){
        ...
        try {
            ...
            while(sc.hasNext()){
                try {
                    ...
                    if(s.length()!=3){
                        ...
                        sc.nextLine();
                        try {
                            throw new Exception("Xuong thu "+dem+" sai thong tin: MA XUONG PHAI DU 3 KY TU");
                        } catch (Exception e) {
                            JOptionPane.showMessageDialog(null, e.getMessage());
                        }
                    }
                        ...
                        if(tenX.length()==0){
                            ...
                            sc.nextLine();
                            try {
                            throw new Exception("Xuong thu "+dem+" sai thong tin: TEN XUONG KHONG DUOC DE TRONG");
                        } catch (Exception e) {
                            JOptionPane.showMessageDialog(null, e.getMessage());
                        }
                        }
                            ...
                            sc.nextLine();
                                try {
                                    throw new Exception("Xuong thu "+dem+" sai thong tin: MO TA KHONG DE TRONG");
                                } catch (Exception e) {
                                    JOptionPane.showMessageDialog(null, e.getMessage());
                                }
                            }
                                ...
                                if(heSo<1 | heSo>20){
                                    try {
                                        throw new Exception("Xuong thu "+dem+" sai thong tin: HE SO PHAI TU 1->20");  
                                    } catch (Exception e) {
                                        JOptionPane.showMessageDialog(null, e.getMessage());
                                    }
                                }else kt=1;
                    ...
                    JOptionPane.showMessageDialog(null, "Xuong thu "+dem+" sai thong tin");
                }
                if(kt==1){
                    XuongSanXuat ss=new XuongSanXuat(maX, tenX, moTa, heSo);
                    xsx.add(ss);
                    kt=0;
                }
            }
            for(XuongSanXuat as:xsx){
                Vector v=new Vector();
                v.add(String.valueOf(as.getMaXuong()));
                v.add(as.getTenXuong());
                v.add(as.getMoTa());
                v.add(String.valueOf(as.getHeSo()));
                a4.add(v);
            }tb2.updateUI();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void initComponents() {
        ...
        comboSoNgayLV = new javax.swing.JComboBox<>();
        ...
        comboSoNgayLV.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(comboSoNgayLV, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(224, 224, 224))
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addGap(243, 243, 243)
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel12)
                    .addComponent(jLabel13)
                    .addComponent(comboSoNgayLV, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
       if(!ktraTrung(comboTenCongNhan.getSelectedItem().toString(), comboTenXuong.getSelectedItem().toString())){
           if(ktT(comboTenCongNhan.getSelectedItem().toString(), Integer.parseInt(comboSoNgayLV.getSelectedItem().toString()))==false){
               Vector v=new Vector();
               v.add(1+tb3.getRowCount()+"");
               v.add(comboTenCongNhan.getSelectedItem().toString());
               v.add(comboTenXuong.getSelectedItem().toString());
               v.add(comboSoNgayLV.getSelectedItem().toString());
               a6.add(v);
               tb3.updateUI();
               DanhSachCong b=new DanhSachCong(comboTenCongNhan.getSelectedItem().toString(), comboTenXuong.getSelectedItem().toString(), Integer.parseInt(comboSoNgayLV.getSelectedItem().toString()));
               ds.add(b);
           }
           else{
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        dm4.setRowCount(0);
        Collections.sort(ds, new Comparator<DanhSachCong>() {
            @Override
            public int compare(DanhSachCong o1, DanhSachCong o2) {
                String[] m1=o1.getTenCN().split(" ");
                String[] m2=o2.getTenCN().split(" ");
                return m1[m1.length-1].compareToIgnoreCase(m2[m2.length-1]);
            }
        });
        for(DanhSachCong as:ds){
            Vector v=new Vector();
            v.add(1+tb4.getRowCount()+"");
            v.add(as.getTenCN());
            v.add(as.getTebXuong());
            v.add(String.valueOf(as.getSoNgayLV()));
            a8.add(v);
        }tb4.updateUI();
    ...
    private javax.swing.JComboBox<String> comboSoNgayLV;
